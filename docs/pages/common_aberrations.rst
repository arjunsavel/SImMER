...
sources in PHARO images. This aliasing effect is known as "waffle mode" (see the below image from Hayward et al. 2001). Especially if multiple authentic sources are in the field of view, 
