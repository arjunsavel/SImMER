...
def check_logsheet(inst, log_name, date=None, add_dark_times=False):
    ...
    def check_date(date, inst, add_dark_times):
        ...
        desired_cols = ['Object', 'Start', 'End', 'Expose', 'ExpTime', \
                        'Coadds', 'Filter', 'Total_tint']
        missing = []
        ...
        assert len(filters) == len(log_frame[log_frame['Object'] != 'dark']) \
